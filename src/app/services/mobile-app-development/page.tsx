        ...
        `}</style>
                ...
                <header className="sp-hero">
                    ...
                    <div className="sp-hero-inner">
                        ...
                        <h1 className="sp-title">Mobile App Development</h1>
                        <p className="sp-subtitle">Cross-platform and native mobile experiences designed for performance, intuitive interactions, and seamless scaling across millions of users.</p>
                    </div>
                </header>
                ...
                <section className="sp-body">
                    <div className="sp-inner">
                        ...
                        <h2 className="sp-section-title">Mobile Experiences That Users Love</h2>

                        <div className="sp-block">
                            <h3>Cross-Platform Development</h3>
                            <p>We build with React Native to deliver native quality apps on both iOS and Android from a single codebase. This approach reduces development time by 40% while maintaining platform specific UI patterns, gesture handling, and performance characteristics that users expect from native apps.</p>
                        </div>

                        <div className="sp-block">
                            <h3>Native iOS & Android</h3>
                            <p>When maximum platform integration is required, we build fully native apps using Swift for iOS and Kotlin for Android. Native development delivers the deepest access to device capabilities including advanced camera APIs, biometric authentication, background processing, and hardware accelerated graphics.</p>
                        </div>

                        <div className="sp-block">
                            <h3>Offline-First Architecture</h3>
                            <p>Our apps work reliably regardless of network conditions. We build with offline first data synchronisation, local caching, optimistic UI updates, and conflict resolution logic that ensures users never lose data or functionality when connectivity drops.</p>
                        </div>
                        ...
                        <div className="sp-grid">
                            <div className="sp-offer">
                                <h4>App Store Ready Builds</h4>
                                <p>Fully tested, optimised, and compliant builds ready for submission to Apple App Store and Google Play Store with all metadata and assets.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>Push Notification System</h4>
                                <p>Segmented, personalised push notification infrastructure with delivery tracking, A/B testing, and user preference management.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>Analytics & Crash Reporting</h4>
                                <p>Integrated analytics tracking user behaviour, session data, and conversion funnels, plus real time crash reporting with stack traces.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>OTA Update Pipeline</h4>
                                <p>Over the air update capability for instant bug fixes and feature rollouts without requiring users to download from the app store.</p>
                            </div>
                        </div>
                        ...
                        <div className="sp-block" style={{ marginTop: '3rem' }}>
                            ...
                            <ul>
                                <li><strong>Cross-Platform:</strong> React Native, Expo, TypeScript</li>
                                <li><strong>Native iOS:</strong> Swift, SwiftUI, UIKit, Core Data</li>
                                <li><strong>Native Android:</strong> Kotlin, Jetpack Compose, Room</li>
                                <li><strong>Backend:</strong> Node.js, Firebase, Supabase, REST/GraphQL APIs</li>
                                <li><strong>Distribution:</strong> App Store Connect, Google Play Console, CodePush OTA</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section className="sp-cta">
                    <div className="sp-cta-inner">
                        ...
                        <p>From concept to App Store, we deliver mobile experiences that delight users and drive business results.</p>
