        ...
        `}</style>
                ...
                <header className="sp-hero">
                    ...
                    <div className="sp-hero-inner">
                        ...
                        <h1 className="sp-title">UI / UX Design</h1>
                        <p className="sp-subtitle">We design product experiences that users genuinely love, grounded in user research, tested through iteration, and built with pixel perfect precision.</p>
                    </div>
                </header>
                ...
                <section className="sp-body">
                    <div className="sp-inner">
                        ...
                        <h2 className="sp-section-title">Design That Drives Business Results</h2>

                        <div className="sp-block">
                            <h3>User Research & Discovery</h3>
                            <p>Every design engagement starts with understanding your users. We conduct stakeholder interviews, competitive analysis, user journey mapping, and where appropriate, usability testing of existing products. This research phase ensures that design decisions are grounded in real user needs rather than assumptions, identifying friction points and opportunities that inform the entire design direction.</p>
                        </div>

                        <div className="sp-block">
                            <h3>Wireframing & Information Architecture</h3>
                            <p>Before visual design begins, we define the structure. Low fidelity wireframes establish page hierarchy, navigation flows, and content organisation. Information architecture maps ensure that users can find what they need intuitively, reducing cognitive load and minimising the number of steps required to complete core tasks.</p>
                        </div>

                        <div className="sp-block">
                            <h3>Visual Design & Design Systems</h3>
                            <p>High fidelity designs built on a systematic foundation. Every project produces a design system with consistent colour palettes, typography scales, spacing tokens, component libraries, and interaction patterns. This system ensures visual consistency across every screen and provides developers with unambiguous specifications for implementation.</p>
                        </div>

                        <div className="sp-block">
                            <h3>Interactive Prototyping</h3>
                            <p>Clickable prototypes that simulate the real product experience before a single line of code is written. Stakeholders and test users can navigate through complete user flows, interact with form elements, and experience transitions and micro animations. Prototyping catches usability issues early when they are cheap to fix, not after development is complete.</p>
                        </div>
                        ...
                        <div className="sp-grid">
                            <div className="sp-offer">
                                ...
                                <p>Token based design system with colour, typography, spacing, and component specifications that ensure consistency and accelerate development.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>High Fidelity Screens</h4>
                                <p>Pixel perfect Figma designs for every screen, state, and breakpoint, with detailed annotations for developer handoff.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>Interactive Prototypes</h4>
                                <p>Clickable Figma prototypes covering all major user flows, including transitions, loading states, and error handling.</p>
                            </div>
                            <div className="sp-offer">
                                <h4>Developer Handoff Package</h4>
                                <p>Organised Figma files with auto layout, component variants, and export specifications that developers can implement directly.</p>
                            </div>
                        </div>
                        ...
                        <div className="sp-block" style={{ marginTop: '3rem' }}>
                            ...
                            <ul>
                                <li><strong>Research Driven:</strong> Every design decision is backed by user research, competitive analysis, or usability testing data</li>
                                <li><strong>Mobile First:</strong> Responsive designs that start from the smallest screen and scale up, ensuring no breakpoint is an afterthought</li>
                                <li><strong>Accessible:</strong> WCAG 2.1 AA compliance built in from the start, including colour contrast, keyboard navigation, and screen reader support</li>
                                <li><strong>Performance Aware:</strong> Designs that consider loading states, skeleton screens, and progressive disclosure to feel fast even on slow connections</li>
                                <li><strong>Tools:</strong> Figma, FigJam, Adobe Creative Suite, Principle, Lottie</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section className="sp-cta">
                    <div className="sp-cta-inner">
                        <h2>Ready to Elevate Your Product Design?</h2>
                        <p>From user research to pixel perfect handoff, we create interfaces that delight users and drive measurable business outcomes.</p>
