...
const CLOUD_PARTNERS = [
  ...
  { name: "", url: "https://cdn.worldvectorlogo.com/logos/microsoft-azure-2.svg" },
...
const SOCIALS = [
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/octabitlogics",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/octabitlogics",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
