...
const STATS = [
  { num: 8,  suffix: "+",  label: "Products Shipped",  sub: "across 5 industries"  },
  { num: 4,  suffix: "M+", label: "Events / Day",       sub: "real-time pipelines"  },
  { num: 10, suffix: "+",  label: "Countries Served",   sub: "globally deployed"    },
  { num: 80, suffix: "%",  label: "Cost Reduction",     sub: "vs legacy approaches" },
];
    ...
    <section id="projects-hero">
      <style>{`
        ...
        @media (max-width: 768px) {
          .ph-glow { width: 100%; height: 300px; }
          .ph-stats { grid-template-columns: repeat(2, 1fr); gap: 2.5rem 0; border-top: none; padding-top: 0; }
          .ph-stat { border-right: none; padding: 1.5rem 1rem; border: 1px solid rgba(59,173,176,0.15); border-radius: 12px; }
        }

        @media (max-width: 480px) {
          #projects-hero { padding-top: 120px; }
          .ph-stats { grid-template-columns: repeat(2, 1fr); gap: 1rem; }
        }
      `}</style>

      <div className="ph-glow" />
      <div className="ph-glow-accent" />
      ...
      <div className="ph-content">
        ...
        >
          From defence grade AI to dual sided marketplaces, explore the products
          we&apos;ve designed, built, and shipped for teams across industries.
        </motion.p>
      </div>
